  ...
  return (
    <div className="min-h-screen flex flex-col">
      <main className="flex-grow">
        <section className="px-3 py-36 mx-auto max-w-screen-lg">
          ...
          <div className="mt-8 flex justify-center gap-x-5 gap-y-3 max-sm:flex-col">
            ...
            <a
              ...
              href="https://github.com/Ankur-0429/LiftLink.git"
              target="_blank"
              rel="noopener">
              <svg
                width="15"
        ...
        <div className="px-3 py-16">
          <div className="mx-auto max-w-screen-lg">
            ...
            <div className="mt-6 grid grid-cols-2 place-items-center gap-x-3 gap-y-6 md:grid-cols-4 opacity-60">
              <Image src="/uber.svg" width={100} height={35} alt="Uber Logo" />
              <Image src="/lyft.svg" width={59} height={42} alt="Lyft Logo" />
              <Image src="/bolt.svg" width={72} height={42} alt="Lyft Logo" />
              <Image src="/ola.svg" width={90} height={90} alt="Lyft Logo" />
            </div>
          </div>
        </div>
      </main>

      <footer className="w-full border-t border-gray-300 py-4 text-sm">
        <div className="container mx-auto px-4 flex flex-wrap justify-between items-center text-gray-600">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-1">
              <div className="bg-blue-100 rounded-lg px-2 py-1">BETA</div>
              <span>•</span>
